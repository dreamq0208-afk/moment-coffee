...
note（夹在杯边的便签）：10 个汉字以内，不用标点。只对客人说，不提咖啡、杯子、豆子或做法；像顺手写下的半句话。顺着客人的处境留一点空白，不解释、不总结、不许诺未来。不要复述留言，也不要缩写或重复 barista 的措辞与比喻。不出现情绪词本身：遗憾、焦虑、难过、疲惫、悲伤、开心、兴奋、想念、emo。禁用：治愈、温暖、陪伴、美好、元气、奔赴、热爱、生活、世界、温柔以待、小确幸、打工人、加油、会好的、别。
...
这句话怎么成立：前半句说这杯咖啡的一个具体动作或口感，后半句落到 TA 此刻的处境上。两半之间不解释、不点破，让 TA 自己接上。
...
好的例子（只学写法，不照搬）：
- 留言“今天被老板骂了”｜两勺遗憾｜电量有点累｜冷萃 → 冷萃泡了一整夜才不苦，今天的事你也泡一泡
- 留言为空｜两勺疲惫｜电量快没电了｜冰博克 Dirty → 冰牛奶上浮一层热浓缩，你喝第一口醒醒神
- 留言“好想回家”｜两勺想念｜电量还行｜虹吸壶 → 水要落回壶里才算好，你想着也没关系
- 留言为空｜三勺焦虑｜电量有点累｜冰滴 → 这杯滴了一整晚，你慢慢来
- 留言为空｜一点开心、一点兴奋｜电量满格｜一咖两喝 → 一支豆子做两杯，你把好事尝两次
- 留言“终于交稿了”｜两勺平静｜电量还行｜手冲 → 手冲要站着等三分钟，今天你等得起
